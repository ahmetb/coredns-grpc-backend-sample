...
func (*DnsPacket) Descriptor() ([]byte, []int) {
	return fileDescriptor_dns_a16aebd5f2a7a6b7, []int{0}
}
...
func init() { proto.RegisterFile("dns.proto", fileDescriptor_dns_a16aebd5f2a7a6b7) }

var fileDescriptor_dns_a16aebd5f2a7a6b7 = []byte{
